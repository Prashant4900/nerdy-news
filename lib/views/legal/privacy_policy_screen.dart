...
<div class="main-container">
  <h2 style="margin-top: 0">News App Privacy Policy</h2>
  <hr style="margin-bottom: .1em" />
  <div id="content">
    <p>
      <strong>Prashant Nigam</strong> built the <strong>Nerdy News</strong> app
      as a Free app. This SERVICE is provided by
      <strong>Prashant Nigam</strong> at no cost and is intended for use as is.
    </p>
    <p>
    ...
    <p>
      ...
      Terms and Conditions, which is accessible at Nerdy News App unless
    ...
    <p>
      ...
      hesitate to contact me at prashantnigam490@gmail.com.
    </p>
  </div>
</div>
''';

class MyPrivacyPolicyScreen extends StatefulWidget {
  const MyPrivacyPolicyScreen({super.key});

  @override
  State<MyPrivacyPolicyScreen> createState() => _MyPrivacyPolicyScreenState();
}

class _MyPrivacyPolicyScreenState extends State<MyPrivacyPolicyScreen> {
